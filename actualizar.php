								...
								<tr id="<?php echo $datos['id']; ?>">
									...
									<td>
										<div class="d-grid gap-2 d-md-block">
											...
											<button id="<?php echo $datos['id']; ?>d" type="button" class="btn btn-dark btn-sm" onclick="eliminar('<?php echo $var; ?>');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
